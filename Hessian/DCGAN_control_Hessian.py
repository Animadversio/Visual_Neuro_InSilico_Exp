...
#%%
torch.save(shuffled_SD, join(datadir, "DCGAN_shuffle.pt"))
    # print(name, Weight.shape, Weight.mean().item(), Weight.std().item())
#%%
DCGAN_sf = loadDCGAN()
DCGAN_sf.load_state_dict(torch.load(join(datadir, "DCGAN_shuffle.pt")))
G_sf = DCGAN_wrapper(DCGAN_sf)
#%%
...
savedir = r"E:\OneDrive - Washington University in St. Louis\HessNetArchit\DCGAN\ctrl_Hessians" # join(datadir, "ctrl_Hessians")
...
figdir = r"E:\OneDrive - Washington University in St. Louis\HessNetArchit\DCGAN"
realfigdir = r"E:\OneDrive - Washington University in St. Louis\Hessian_summary\DCGAN"

modelnm = "DCGAN_shuffle"
...
corr_mat_vec_ctrl = compute_vector_hess_corr(eva_ctrl, evc_ctrl, figdir=figdir, savelabel=modelnm)
...
fig0 = plot_spectra(eva_real, savename="DCGAN_shuffle_spectrum_cmp", figdir=figdir, abs=True,
            titstr="DCGAN cmp", label="real", fig=None)
fig0 = plot_spectra(eva_ctrl, savename="DCGAN_shuffle_spectrum_cmp", figdir=figdir, abs=True,
            titstr="DCGAN cmp", label="shuffled", fig=fig0)
#%%
