...
#%%
# classvec = G_sf.BigGAN.big_gan.shared(torch.zeros(1, dtype=torch.int64).cuda())
# img = G_sf.BigGAN.big_gan(torch.randn(16, 128).cuda(), classvec.repeat(16,1))
# ToPILImage()(make_grid((img+1)/2).cpu()).show()
#%%
...
savedir = r"E:\OneDrive - Washington University in St. Louis\HessNetArchit\BigBiGAN\ctrl_Hessians"
...
fig0 = plot_spectra(eva_real, savename="BigBiGAN_shuffle_spectrum_cmp", figdir=figdir, abs=True,
            titstr="BigBiGAN cmp", label="real", fig=None)
fig0 = plot_spectra(eva_ctrl, savename="BigBiGAN_shuffle_spectrum_cmp", figdir=figdir, abs=True,
            titstr="BigBiGAN cmp", label="shuffled", fig=fig0)
#%%
